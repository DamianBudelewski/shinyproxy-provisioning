...
## Infrastructure
<p align="center"> <img src="images/schema.png" width="70%" height="70%"> </p>
...
- [x] Configure Auth0.
- [x] Nginx SSL Proxy.
- [x] Add Terraform remote state storage on Azure.
...
* [Grafana tutorial for Azure Monitor source](https://grafana.com/docs/grafana/latest/features/datasources/azuremonitor/)
